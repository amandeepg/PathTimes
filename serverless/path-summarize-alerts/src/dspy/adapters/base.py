...
class Adapter:
    ...
    def _call_preprocess(
        ...
        if self.use_native_function_calling:
            ...
            if tool_call_output_field_name and litellm.supports_function_calling(
                model=lm.model
            ):
                ...
                signature_for_native_function_calling = (
                    signature_for_native_function_calling.delete(
    ...
    def _call_postprocess(
        ...
        citation_output_field_name = self._get_citation_output_field_name(
            original_signature
        )
            ...
            messages.append(
                {
                    "role": "user",
                    "content": self.format_user_message_content(
                        signature, demo, prefix=incomplete_demo_prefix
                    ),
                }
            )
            messages.append(
    ...
    def format_conversation_history(
        ...
        conversation_history = (
            inputs[history_field_name].messages
