...
SCREENSHOT_FOLDER="app/src/test/snapshots/images/Pixel_8_Pro/ca.amandeep.path.ui.main_MainScreenshotTest_"
SCREENSHOT_1="${SCREENSHOT_FOLDER}screenshotMain[darkMode=true,device=Pixel_8_Pro,alertsExp=null,dirWarn=false,helpGuide=false,showOppoDir=false,showNotifs=true,updatedWhen=0,shortNames=false,].png"
SCREENSHOT_2="${SCREENSHOT_FOLDER}screenshotMain[darkMode=false,device=Pixel_8_Pro,alertsExp=true,dirWarn=false,helpGuide=true,showOppoDir=false,showNotifs=true,updatedWhen=0,shortNames=false,].png"
SCREENSHOT_3_1="${SCREENSHOT_FOLDER}screenshotMain[darkMode=true,device=Pixel_8_Pro,alertsExp=null,dirWarn=false,helpGuide=true,showOppoDir=true,showNotifs=true,updatedWhen=0,shortNames=false,].png"
SCREENSHOT_3_2="${SCREENSHOT_FOLDER}screenshotMain[darkMode=false,device=Pixel_8_Pro,alertsExp=null,dirWarn=false,helpGuide=true,showOppoDir=true,showNotifs=true,updatedWhen=0,shortNames=false,].png"
SCREENSHOT_3="DiagonalDown.png"
SCREENSHOT_4="${SCREENSHOT_FOLDER}screenshotMain[darkMode=true,device=Pixel_8_Pro,alertsExp=false,dirWarn=false,helpGuide=true,showOppoDir=false,showNotifs=true,updatedWhen=0,shortNames=false,].png"
